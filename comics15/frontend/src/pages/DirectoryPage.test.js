...
vi.mock('../router/index.js', () => ({
  createSeriesDirectoryRoute: vi.fn((series, path) => `/dir/${series}/${path}`),
  createParentDirectoryRoute: vi.fn((series, path) => `/back/${series}/${path}`),
...
describe('DirectoryPage', () => {
  ...
  it('显示目录节点和返回上一级按钮', () => {
    ...
    expect(wrapper.text()).toContain('返回上一级')
  })
  ...
  it('点击目录节点会进入下一层', async () => {
    ...
    await wrapper.get('button.directory-node').trigger('click')
