...
vi.mock('@/stores/series-store', () => ({
  useSeriesStore: vi.fn()
}))

vi.mock('@/router', () => ({
  createSeriesRootRoute: vi.fn((series: string) => `/series/${series}/dir`)
}))
...
import { useSeriesStore as _useSeriesStore } from '@/stores/series-store'
const useSeriesStore = _useSeriesStore as unknown as ReturnType<typeof vi.fn>
